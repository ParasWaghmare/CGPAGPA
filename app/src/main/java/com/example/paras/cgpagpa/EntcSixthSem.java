...
public class EntcSixthSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entc_sixth_sem);

        display_data = findViewById(R.id.entcSixthSgpa);
        csSecondPer = findViewById(R.id.entcSixthPercentage);

        meSpinnerFirst1 = findViewById(R.id.entcSixthSpinner1);
        meSpinnerFirst2 = findViewById(R.id.entcSixthSpinner2);
        meSpinnerFirst3 = findViewById(R.id.entcSixthSpinner3);
        meSpinnerFirst4 = findViewById(R.id.entcSixthSpinner4);
        meSpinnerFirst5 = findViewById(R.id.entcSixthSpinner5);
        meSpinnerFirst6 = findViewById(R.id.entcSixthSpinner6);
        meSpinnerFirst7 = findViewById(R.id.entcSixthSpinner7);
        meSpinnerFirst8 = findViewById(R.id.entcSixthSpinner8);
        meSpinnerFirst9 = findViewById(R.id.entcSixthSpinner9);
        meSpinnerFirst10 = findViewById(R.id.entcSixthSpinner10);
        meSpinnerFirst11 = findViewById(R.id.entcSixthSpinner11);

        meFirstGr1 = findViewById(R.id.entcGradeSixth1);
        meFirstGr2 = findViewById(R.id.entcGradeSixth2);
        meFirstGr3 = findViewById(R.id.entcGradeSixth3);
        meFirstGr4 = findViewById(R.id.entcGradeSixth4);
        meFirstGr5 = findViewById(R.id.entcGradeSixth5);
        meFirstGr6 = findViewById(R.id.entcGradeSixth6);
        meFirstGr7 = findViewById(R.id.entcGradeSixth7);
        meFirstGr8 = findViewById(R.id.entcGradeSixth8);
        meFirstGr9 = findViewById(R.id.entcGradeSixth9);
        meFirstGr10 = findViewById(R.id.entcGradeSixth10);
        meFirstGr11= findViewById(R.id.entcGradeSixth11);
    ...
    public void displayResultEntcSixth(View view){
        double gp = record1*3+record2*3+record3+record4*3+record5*3+record6+record7*3+record8+record9+record10*2+record11*2;
        double gpa = gp / 23;
