...
public class InstThirdSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inst_third_sem);


        display_data = findViewById(R.id.instThirdSgpa);
        csSecondPer  = findViewById(R.id.instThirdPercentage);

        meSpinnerFirst1 = findViewById(R.id.instThirdSpinner1);
        meSpinnerFirst2 = findViewById(R.id.instThirdSpinner2);
        meSpinnerFirst3 = findViewById(R.id.instThirdSpinner3);
        meSpinnerFirst4 = findViewById(R.id.instThirdSpinner4);
        meSpinnerFirst5 = findViewById(R.id.instThirdSpinner5);
        meSpinnerFirst6 = findViewById(R.id.instThirdSpinner6);
        meSpinnerFirst7 = findViewById(R.id.instThirdSpinner7);
        meSpinnerFirst8 = findViewById(R.id.instThirdSpinner8);
        meSpinnerFirst9 = findViewById(R.id.instThirdSpinner9);
        meSpinnerFirst10 = findViewById(R.id.instThirdSpinner10);

        meFirstGr1= findViewById(R.id.instGradeThird1);
        meFirstGr2= findViewById(R.id.instGradeThird2);
        meFirstGr3= findViewById(R.id.instGradeThird3);
        meFirstGr4= findViewById(R.id.instGradeThird4);
        meFirstGr5= findViewById(R.id.instGradeThird5);
        meFirstGr6= findViewById(R.id.instGradeThird6);
        meFirstGr7= findViewById(R.id.instGradeThird7);
        meFirstGr8 = findViewById(R.id.instGradeThird8);
        meFirstGr9 = findViewById(R.id.instGradeThird9);
        meFirstGr10 = findViewById(R.id.instGradeThird10);
    ...
    public void displayResultInstThird(View view){
        double gp = record1*4+record2*3+record3*4+record4*3+record5*3+record6*2+record7+record8+record9+record10;
        double gpa = gp / 23;
