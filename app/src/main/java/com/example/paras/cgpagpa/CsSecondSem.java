...
public class CsSecondSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cs_second_sem);

        display_data = findViewById(R.id.csSgpaSec);
        csSecondPer  = findViewById(R.id.csSecondPercentage);

        csSpinnerSec1 = findViewById(R.id.csSpinnerSec1);
        csSpinnerSec2 = findViewById(R.id.csSpinnerSec2);
        csSpinnerSec3 = findViewById(R.id.csSpinnerSec3);
        csSpinnerSec4 = findViewById(R.id.csSpinnerSec4);
        csSpinnerSec5 = findViewById(R.id.csSpinnerSec5);
        csSpinnerSec6 = findViewById(R.id.csSpinnerSec6);
        csSpinnerSec7 = findViewById(R.id.csSpinnerSec7);
        csSpinnerSec8 = findViewById(R.id.csSpinnerSec8);
        csSpinnerSec9 = findViewById(R.id.csSpinnerSec9);
        csSpinnerSec10 = findViewById(R.id.csSpinnerSec10);

        csSecondGr1= findViewById(R.id.csGradeSecond1);
        csSecondGr2= findViewById(R.id.csGradeSecond2);
        csSecondGr3= findViewById(R.id.csGradeSecond3);
        csSecondGr4= findViewById(R.id.csGradeSecond4);
        csSecondGr5= findViewById(R.id.csGradeSecond5);
        csSecondGr6= findViewById(R.id.csGradeSecond6);
        csSecondGr7= findViewById(R.id.csGradeSecond7);
        csSecondGr8 = findViewById(R.id.csGradeSecond8);
        csSecondGr9 = findViewById(R.id.csGradeSecond9);
        csSecondGr10 = findViewById(R.id.csGradeSecond10);
    ...
    public void displayResultCsSec(View view){
    ...
    public void resetCsSecResult(View view){
        csSecondGr1.setText("");
        csSecondGr2.setText("");
        csSecondGr3.setText("");
        csSecondGr4.setText("");
        ...
        csSecondGr8.setText("");
        csSecondGr9.setText("");
        csSecondGr10.setText("");
        display_data.setText(R.string.sgpa);
        csSecondPer.setText(R.string.percentage);
