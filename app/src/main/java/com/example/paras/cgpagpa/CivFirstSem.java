...
public class CivFirstSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civ_first_sem);


        Spinner sp1 = findViewById(R.id.civSpinner1);
        Spinner sp2 = findViewById(R.id.civSpinner2);
        Spinner sp3 = findViewById(R.id.civSpinner3);
        Spinner sp4 = findViewById(R.id.civSpinner4);
        Spinner sp5 = findViewById(R.id.civSpinner5);
        Spinner sp6 = findViewById(R.id.civSpinner6);
        Spinner sp7 = findViewById(R.id.civSpinner7);
        Spinner sp8 = findViewById(R.id.civSpinner8);
        Spinner sp9 = findViewById(R.id.civSpinner9);
        Spinner sp10 = findViewById(R.id.civSpinner10);

        display_data = findViewById(R.id.civFirstSgpa);
        csFirstPer = findViewById(R.id.civFirstPercentage);

        gr1 = findViewById(R.id.civGradeFirst1);
        gr2 = findViewById(R.id.civGradeFirst2);
        gr3 = findViewById(R.id.civGradeFirst3);
        gr4 = findViewById(R.id.civGradeFirst4);
        gr5 = findViewById(R.id.civGradeFirst5);
        gr6 = findViewById(R.id.civGradeFirst6);
        gr7 = findViewById(R.id.civGradeFirst7);
        gr8 = findViewById(R.id.civGradeFirst8);
        gr9 = findViewById(R.id.civGradeFirst9);
        gr10 = findViewById(R.id.civGradeFirst10);
    ...
    public void displayCivFirstResult(View view) {
