...
public class EntcFirstSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entc_first_sem);



        display_data = findViewById(R.id.entcSgpaFirst);
        csSecondPer  = findViewById(R.id.entcFirstPercentage);

        meSpinnerFirst1 = findViewById(R.id.entcSpinnerFirst1);
        meSpinnerFirst2 = findViewById(R.id.entcSpinnerFirst2);
        meSpinnerFirst3 = findViewById(R.id.entcSpinnerFirst3);
        meSpinnerFirst4 = findViewById(R.id.entcSpinnerFirst4);
        meSpinnerFirst5 = findViewById(R.id.entcSpinnerFirst5);
        meSpinnerFirst6 = findViewById(R.id.entcSpinnerFirst6);
        meSpinnerFirst7 = findViewById(R.id.entcSpinnerFirst7);
        meSpinnerFirst8 = findViewById(R.id.entcSpinnerFirst8);
        meSpinnerFirst9 = findViewById(R.id.entcSpinnerFirst9);
        meSpinnerFirst10 = findViewById(R.id.entcSpinnerFirst10);

        meFirstGr1= findViewById(R.id.entcGradeFirst1);
        meFirstGr2= findViewById(R.id.entcGradeFirst2);
        meFirstGr3= findViewById(R.id.entcGradeFirst3);
        meFirstGr4= findViewById(R.id.entcGradeFirst4);
        meFirstGr5= findViewById(R.id.entcGradeFirst5);
        meFirstGr6= findViewById(R.id.entcGradeFirst6);
        meFirstGr7= findViewById(R.id.entcGradeFirst7);
        meFirstGr8 = findViewById(R.id.entcGradeFirst8);
        meFirstGr9 = findViewById(R.id.entcGradeFirst9);
        meFirstGr10 = findViewById(R.id.entcGradeFirst10);
    ...
    public void displayResultEntcFirst(View view){
