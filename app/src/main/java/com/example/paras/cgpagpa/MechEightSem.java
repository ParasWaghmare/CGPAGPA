...
public class MechEightSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mech_eight_sem);


        display_data = findViewById(R.id.meEightSgpa);
        csSecondPer = findViewById(R.id.meEightPercentage);

        meSpinnerFirst1 = findViewById(R.id.meEightSpinner1);
        meSpinnerFirst2 = findViewById(R.id.meEightSpinner2);
        meSpinnerFirst3 = findViewById(R.id.meEightSpinner3);
        meSpinnerFirst4 = findViewById(R.id.meEightSpinner4);
        meSpinnerFirst5 = findViewById(R.id.meEightSpinner5);
        meSpinnerFirst6 = findViewById(R.id.meEightSpinner6);
        meSpinnerFirst7 = findViewById(R.id.meEightSpinner7);
        meSpinnerFirst8 = findViewById(R.id.meEightSpinner8);
        meSpinnerFirst9 = findViewById(R.id.meEightSpinner9);
        meSpinnerFirst10 = findViewById(R.id.meEightSpinner10);
        meSpinnerFirst11 = findViewById(R.id.meEightSpinner11);

        meFirstGr1 = findViewById(R.id.meGradeEight1);
        meFirstGr2 = findViewById(R.id.meGradeEight2);
        meFirstGr3 = findViewById(R.id.meGradeEight3);
        meFirstGr4 = findViewById(R.id.meGradeEight4);
        meFirstGr5 = findViewById(R.id.meGradeEight5);
        meFirstGr6 = findViewById(R.id.meGradeEight6);
        meFirstGr7 = findViewById(R.id.meGradeEight7);
        meFirstGr8 = findViewById(R.id.meGradeEight8);
        meFirstGr9 = findViewById(R.id.meGradeEight9);
        meFirstGr10 = findViewById(R.id.meGradeEight10);
        meFirstGr11= findViewById(R.id.meGradeEight11);
    ...
    public void displayResultMeEight(View view){
        double gp = record1*3+record2*3+record3*3+record4*3+record5+record6+record7+record8*4+record9+record10+record11*2;
        double gpa = gp / 23;
