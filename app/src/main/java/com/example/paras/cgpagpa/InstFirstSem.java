...
public class InstFirstSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inst_first_sem);


        display_data = findViewById(R.id.instSgpaFirst);
        csSecondPer  = findViewById(R.id.instFirstPercentage);

        meSpinnerFirst1 = findViewById(R.id.instSpinnerFirst1);
        meSpinnerFirst2 = findViewById(R.id.instSpinnerFirst2);
        meSpinnerFirst3 = findViewById(R.id.instSpinnerFirst3);
        meSpinnerFirst4 = findViewById(R.id.instSpinnerFirst4);
        meSpinnerFirst5 = findViewById(R.id.instSpinnerFirst5);
        meSpinnerFirst6 = findViewById(R.id.instSpinnerFirst6);
        meSpinnerFirst7 = findViewById(R.id.instSpinnerFirst7);
        meSpinnerFirst8 = findViewById(R.id.instSpinnerFirst8);
        meSpinnerFirst9 = findViewById(R.id.instSpinnerFirst9);
        meSpinnerFirst10 = findViewById(R.id.instSpinnerFirst10);

        meFirstGr1= findViewById(R.id.instGradeFirst1);
        meFirstGr2= findViewById(R.id.instGradeFirst2);
        meFirstGr3= findViewById(R.id.instGradeFirst3);
        meFirstGr4= findViewById(R.id.instGradeFirst4);
        meFirstGr5= findViewById(R.id.instGradeFirst5);
        meFirstGr6= findViewById(R.id.instGradeFirst6);
        meFirstGr7= findViewById(R.id.instGradeFirst7);
        meFirstGr8 = findViewById(R.id.instGradeFirst8);
        meFirstGr9 = findViewById(R.id.instGradeFirst9);
        meFirstGr10 = findViewById(R.id.instGradeFirst10);
    ...
    public void displayResultInstFirst(View view){
