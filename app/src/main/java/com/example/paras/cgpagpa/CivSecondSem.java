...
public class CivSecondSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civ_second_sem);

        display_data = findViewById(R.id.civSgpaSec);
        csSecondPer  = findViewById(R.id.civSecondPercentage);

        csSpinnerSec1 = findViewById(R.id.civSpinnerSec1);
        csSpinnerSec2 = findViewById(R.id.civSpinnerSec2);
        csSpinnerSec3 = findViewById(R.id.civSpinnerSec3);
        csSpinnerSec4 = findViewById(R.id.civSpinnerSec4);
        csSpinnerSec5 = findViewById(R.id.civSpinnerSec5);
        csSpinnerSec6 = findViewById(R.id.civSpinnerSec6);
        csSpinnerSec7 = findViewById(R.id.civSpinnerSec7);
        csSpinnerSec8 = findViewById(R.id.civSpinnerSec8);
        csSpinnerSec9 = findViewById(R.id.civSpinnerSec9);
        csSpinnerSec10 = findViewById(R.id.civSpinnerSec10);

        csSecondGr1= findViewById(R.id.civGradeSecond1);
        csSecondGr2= findViewById(R.id.civGradeSecond2);
        csSecondGr3= findViewById(R.id.civGradeSecond3);
        csSecondGr4= findViewById(R.id.civGradeSecond4);
        csSecondGr5= findViewById(R.id.civGradeSecond5);
        csSecondGr6= findViewById(R.id.civGradeSecond6);
        csSecondGr7= findViewById(R.id.civGradeSecond7);
        csSecondGr8 = findViewById(R.id.civGradeSecond8);
        csSecondGr9 = findViewById(R.id.civGradeSecond9);
        csSecondGr10 = findViewById(R.id.civGradeSecond10);
    ...
    public void displayResultCivSec(View view){
