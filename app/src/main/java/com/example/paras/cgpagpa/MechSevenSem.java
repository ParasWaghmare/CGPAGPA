...
public class MechSevenSem extends AppCompatActivity  {

    private Spinner meSpinnerFirst1,meSpinnerFirst2,meSpinnerFirst3,meSpinnerFirst4,meSpinnerFirst5,meSpinnerFirst6,meSpinnerFirst7,meSpinnerFirst8,meSpinnerFirst9,meSpinnerFirst10,meSpinnerFirst11;
    private ArrayAdapter<String> csSecadapter;
    private ArrayAdapter<String> eleAdapter;
    private ArrayAdapter<String> interAdapter;
    private  String grades[] = {"A+","A","B+","B","C+","C","F"} ;

    private String electiv[] = {"Automobile Engg.-1","Mechatronic System","Tool Engineering","DOTE and ST"};
    private String inter[] = {"Operation Research","Renewable Energy Source","Introduction to Robotics","MMCE"};
    ...
    private TextView meFirstGr1,meFirstGr2,meFirstGr3,meFirstGr4,meFirstGr5,meFirstGr6,meFirstGr7,meFirstGr8,meFirstGr9,meFirstGr10,meFirstGr11;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mech_seven_sem);



        display_data = findViewById(R.id.meSevenSgpa);
        csSecondPer = findViewById(R.id.meSevenPercentage);

        meSpinnerFirst1 = findViewById(R.id.meSevenSpinner1);
        meSpinnerFirst2 = findViewById(R.id.meSevenSpinner2);
        meSpinnerFirst3 = findViewById(R.id.meSevenSpinner3);
        meSpinnerFirst4 = findViewById(R.id.meSevenSpinner4);
        meSpinnerFirst5 = findViewById(R.id.meSevenSpinner5);
        meSpinnerFirst6 = findViewById(R.id.meSevenSpinner6);
        meSpinnerFirst7 = findViewById(R.id.meSevenSpinner7);
        meSpinnerFirst8 = findViewById(R.id.meSevenSpinner8);
        meSpinnerFirst9 = findViewById(R.id.meSevenSpinner9);
        meSpinnerFirst10 = findViewById(R.id.meSevenSpinner10);
        meSpinnerFirst11 = findViewById(R.id.meSevenSpinner11);

        meFirstGr1 = findViewById(R.id.meGradeSeven1);
        meFirstGr2 = findViewById(R.id.meGradeSeven2);
        meFirstGr3 = findViewById(R.id.meGradeSeven3);
        meFirstGr4 = findViewById(R.id.meGradeSeven4);
        meFirstGr5 = findViewById(R.id.meGradeSeven5);
        meFirstGr6 = findViewById(R.id.meGradeSeven6);
        meFirstGr7 = findViewById(R.id.meGradeSeven7);
        meFirstGr8 = findViewById(R.id.meGradeSeven8);
        meFirstGr9 = findViewById(R.id.meGradeSeven9);
        meFirstGr10 = findViewById(R.id.meGradeSeven10);
        meFirstGr11= findViewById(R.id.meGradeSeven11);
        ...
        meSpinnerFirst11.setAdapter(csSecadapter);
        ...
        meSpinnerFirst11.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i) {
                    case 0:
                        meFirstGr11.setText("A+");
                        record11 = 10;
    ...
    public void displayResultMeSeven(View view){
        double gp = record1*3+record2*3+record3*3+record4*3+record5*2+record6+record7+record8+record9*2+record10*2+record11*2;
        double gpa = gp / 23;
