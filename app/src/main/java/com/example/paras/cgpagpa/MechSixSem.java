...
public class MechSixSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mech_six_sem);

        display_data = findViewById(R.id.meSixSgpa);
        csSecondPer = findViewById(R.id.meSixPercentage);

        meSpinnerFirst1 = findViewById(R.id.meSixSpinner1);
        meSpinnerFirst2 = findViewById(R.id.meSixSpinner2);
        meSpinnerFirst3 = findViewById(R.id.meSixSpinner3);
        meSpinnerFirst4 = findViewById(R.id.meSixSpinner4);
        meSpinnerFirst5 = findViewById(R.id.meSixSpinner5);
        meSpinnerFirst6 = findViewById(R.id.meSixSpinner6);
        meSpinnerFirst7 = findViewById(R.id.meSixSpinner7);
        meSpinnerFirst8 = findViewById(R.id.meSixSpinner8);
        meSpinnerFirst9 = findViewById(R.id.meSixSpinner9);
        meSpinnerFirst10 = findViewById(R.id.meSixSpinner10);
        meSpinnerFirst11 = findViewById(R.id.meSixSpinner11);

        meFirstGr1 = findViewById(R.id.meGradeSix1);
        meFirstGr2 = findViewById(R.id.meGradeSix2);
        meFirstGr3 = findViewById(R.id.meGradeSix3);
        meFirstGr4 = findViewById(R.id.meGradeSix4);
        meFirstGr5 = findViewById(R.id.meGradeSix5);
        meFirstGr6 = findViewById(R.id.meGradeSix6);
        meFirstGr7 = findViewById(R.id.meGradeSix7);
        meFirstGr8 = findViewById(R.id.meGradeSix8);
        meFirstGr9 = findViewById(R.id.meGradeSix9);
        meFirstGr10 = findViewById(R.id.meGradeSix10);
        meFirstGr11= findViewById(R.id.meGradeSix11);
    ...
    public void displayResultMeSix(View view){
        double gp = record1*3+record2*3+record3*3+record4*3+record5*3+record6+record7+record8+record9+record10*2+record11*2;
        double gpa = gp / 23;
