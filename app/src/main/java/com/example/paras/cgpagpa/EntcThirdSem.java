...
public class EntcThirdSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entc_third_sem);


        display_data = findViewById(R.id.entcThirdSgpa);
        csSecondPer  = findViewById(R.id.entcThirdPercentage);

        meSpinnerFirst1 = findViewById(R.id.entcThirdSpinner1);
        meSpinnerFirst2 = findViewById(R.id.entcThirdSpinner2);
        meSpinnerFirst3 = findViewById(R.id.entcThirdSpinner3);
        meSpinnerFirst4 = findViewById(R.id.entcThirdSpinner4);
        meSpinnerFirst5 = findViewById(R.id.entcThirdSpinner5);
        meSpinnerFirst6 = findViewById(R.id.entcThirdSpinner6);
        meSpinnerFirst7 = findViewById(R.id.entcThirdSpinner7);
        meSpinnerFirst8 = findViewById(R.id.entcThirdSpinner8);
        meSpinnerFirst9 = findViewById(R.id.entcThirdSpinner9);
        meSpinnerFirst10 = findViewById(R.id.entcThirdSpinner10);

        meFirstGr1= findViewById(R.id.entcGradeThird1);
        meFirstGr2= findViewById(R.id.entcGradeThird2);
        meFirstGr3= findViewById(R.id.entcGradeThird3);
        meFirstGr4= findViewById(R.id.entcGradeThird4);
        meFirstGr5= findViewById(R.id.entcGradeThird5);
        meFirstGr6= findViewById(R.id.entcGradeThird6);
        meFirstGr7= findViewById(R.id.entcGradeThird7);
        meFirstGr8 = findViewById(R.id.entcGradeThird8);
        meFirstGr9 = findViewById(R.id.entcGradeThird9);
        meFirstGr10 = findViewById(R.id.entcGradeThird10);
    ...
    public void displayResultEntcThird(View view){
        double gp = record1*4+record2*3+record3+record4*4+record5+record6*3+record7+record8*3+record9+record10*2;
        double gpa = gp / 23;
