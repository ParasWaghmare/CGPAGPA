...
public class MechFourthSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mech_fourth_sem);


        display_data = findViewById(R.id.meFourthSgpa);
        csSecondPer = findViewById(R.id.meFourthPercentage);

        meSpinnerFirst1 = findViewById(R.id.meFourthSpinner1);
        meSpinnerFirst2 = findViewById(R.id.meFourthSpinner2);
        meSpinnerFirst3 = findViewById(R.id.meFourthSpinner3);
        meSpinnerFirst4 = findViewById(R.id.meFourthSpinner4);
        meSpinnerFirst5 = findViewById(R.id.meFourthSpinner5);
        meSpinnerFirst6 = findViewById(R.id.meFourthSpinner6);
        meSpinnerFirst7 = findViewById(R.id.meFourthSpinner7);
        meSpinnerFirst8 = findViewById(R.id.meFourthSpinner8);
        meSpinnerFirst9 = findViewById(R.id.meFourthSpinner9);
        meSpinnerFirst10 = findViewById(R.id.meFourthSpinner10);
        meSpinnerFirst11 = findViewById(R.id.meFourthSpinner11);

        meFirstGr1 = findViewById(R.id.meGradeFourth1);
        meFirstGr2 = findViewById(R.id.meGradeFourth2);
        meFirstGr3 = findViewById(R.id.meGradeFourth3);
        meFirstGr4 = findViewById(R.id.meGradeFourth4);
        meFirstGr5 = findViewById(R.id.meGradeFourth5);
        meFirstGr6 = findViewById(R.id.meGradeFourth6);
        meFirstGr7 = findViewById(R.id.meGradeFourth7);
        meFirstGr8 = findViewById(R.id.meGradeFourth8);
        meFirstGr9 = findViewById(R.id.meGradeFourth9);
        meFirstGr10 = findViewById(R.id.meGradeFourth10);
        meFirstGr11= findViewById(R.id.meGradeFourth11);
    ...
    public void displayResultMeFourth(View view){
        double gp = record1*3+record2*3+record3*3+record4*3+record5*3+record6*2+record7+record8+record9+record10+record11*2;
        double gpa = gp / 23;
