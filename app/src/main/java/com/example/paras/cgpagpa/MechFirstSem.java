...
public class MechFirstSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mech_first_sem);

        display_data = findViewById(R.id.meSgpaFirst);
        csSecondPer  = findViewById(R.id.meFirstPercentage);

        meSpinnerFirst1 = findViewById(R.id.meSpinnerFirst1);
        meSpinnerFirst2 = findViewById(R.id.meSpinnerFirst2);
        meSpinnerFirst3 = findViewById(R.id.meSpinnerFirst3);
        meSpinnerFirst4 = findViewById(R.id.meSpinnerFirst4);
        meSpinnerFirst5 = findViewById(R.id.meSpinnerFirst5);
        meSpinnerFirst6 = findViewById(R.id.meSpinnerFirst6);
        meSpinnerFirst7 = findViewById(R.id.meSpinnerFirst7);
        meSpinnerFirst8 = findViewById(R.id.meSpinnerFirst8);
        meSpinnerFirst9 = findViewById(R.id.meSpinnerFirst9);
        meSpinnerFirst10 = findViewById(R.id.meSpinnerFirst10);

        meFirstGr1= findViewById(R.id.meGradeFirst1);
        meFirstGr2= findViewById(R.id.meGradeFirst2);
        meFirstGr3= findViewById(R.id.meGradeFirst3);
        meFirstGr4= findViewById(R.id.meGradeFirst4);
        meFirstGr5= findViewById(R.id.meGradeFirst5);
        meFirstGr6= findViewById(R.id.meGradeFirst6);
        meFirstGr7= findViewById(R.id.meGradeFirst7);
        meFirstGr8 = findViewById(R.id.meGradeFirst8);
        meFirstGr9 = findViewById(R.id.meGradeFirst9);
        meFirstGr10 = findViewById(R.id.meGradeFirst10);
    ...
    public void displayResultMeFirst(View view){
