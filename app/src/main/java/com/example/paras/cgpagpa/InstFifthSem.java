...
public class InstFifthSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inst_fifth_sem);


        display_data = findViewById(R.id.instFifthSgpa);
        csSecondPer  = findViewById(R.id.instFifthPercentage);

        meSpinnerFirst1 = findViewById(R.id.instFifthSpinner1);
        meSpinnerFirst2 = findViewById(R.id.instFifthSpinner2);
        meSpinnerFirst3 = findViewById(R.id.instFifthSpinner3);
        meSpinnerFirst4 = findViewById(R.id.instFifthSpinner4);
        meSpinnerFirst5 = findViewById(R.id.instFifthSpinner5);
        meSpinnerFirst6 = findViewById(R.id.instFifthSpinner6);
        meSpinnerFirst7 = findViewById(R.id.instFifthSpinner7);
        meSpinnerFirst8 = findViewById(R.id.instFifthSpinner8);
        meSpinnerFirst9 = findViewById(R.id.instFifthSpinner9);
        meSpinnerFirst10 = findViewById(R.id.instFifthSpinner10);
        meSpinnerFirst11  = findViewById(R.id.instFifthSpinner11);

        meFirstGr1= findViewById(R.id.instGradeFifth1);
        meFirstGr2= findViewById(R.id.instGradeFifth2);
        meFirstGr3= findViewById(R.id.instGradeFifth3);
        meFirstGr4= findViewById(R.id.instGradeFifth4);
        meFirstGr5= findViewById(R.id.instGradeFifth5);
        meFirstGr6= findViewById(R.id.instGradeFifth6);
        meFirstGr7= findViewById(R.id.instGradeFifth7);
        meFirstGr8 = findViewById(R.id.instGradeFifth8);
        meFirstGr9 = findViewById(R.id.instGradeFifth9);
        meFirstGr10 = findViewById(R.id.instGradeFifth10);
        meFirstGr11 = findViewById(R.id.instGradeFifth11);
    ...
    public void displayResultInstFifth(View view){
        double gp = record1*3+record2*3+record3*3+record4*3+record5*3+record6+record7+record8+record9+record10+record11*2;
        double gpa = gp / 23;
