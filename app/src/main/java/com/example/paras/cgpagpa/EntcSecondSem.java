...
public class EntcSecondSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entc_second_sem);


        display_data = findViewById(R.id.entcSecondSgpa);
        csSecondPer  = findViewById(R.id.entcSecondPercentage);

        meSpinnerFirst1 = findViewById(R.id.entcSecondSpinner1);
        meSpinnerFirst2 = findViewById(R.id.entcSecondSpinner2);
        meSpinnerFirst3 = findViewById(R.id.entcSecondSpinner3);
        meSpinnerFirst4 = findViewById(R.id.entcSecondSpinner4);
        meSpinnerFirst5 = findViewById(R.id.entcSecondSpinner5);
        meSpinnerFirst6 = findViewById(R.id.entcSecondSpinner6);
        meSpinnerFirst7 = findViewById(R.id.entcSecondSpinner7);
        meSpinnerFirst8 = findViewById(R.id.entcSecondSpinner8);
        meSpinnerFirst9 = findViewById(R.id.entcSecondSpinner9);
        meSpinnerFirst10 = findViewById(R.id.entcSecondSpinner10);

        meFirstGr1= findViewById(R.id.entcGradeSecond1);
        meFirstGr2= findViewById(R.id.entcGradeSecond2);
        meFirstGr3= findViewById(R.id.entcGradeSecond3);
        meFirstGr4= findViewById(R.id.entcGradeSecond4);
        meFirstGr5= findViewById(R.id.entcGradeSecond5);
        meFirstGr6= findViewById(R.id.entcGradeSecond6);
        meFirstGr7= findViewById(R.id.entcGradeSecond7);
        meFirstGr8 = findViewById(R.id.entcGradeSecond8);
        meFirstGr9 = findViewById(R.id.entcGradeSecond9);
        meFirstGr10 = findViewById(R.id.entcGradeSecond10);
    ...
    public void displayResultEntcSecond(View view){
