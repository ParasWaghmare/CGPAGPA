...
public class EntcFourthSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entc_fourth_sem);


        display_data = findViewById(R.id.entcFourthSgpa);
        csSecondPer  = findViewById(R.id.entcFourthPercentage);

        meSpinnerFirst1 = findViewById(R.id.entcFourthSpinner1);
        meSpinnerFirst2 = findViewById(R.id.entcFourthSpinner2);
        meSpinnerFirst3 = findViewById(R.id.entcFourthSpinner3);
        meSpinnerFirst4 = findViewById(R.id.entcFourthSpinner4);
        meSpinnerFirst5 = findViewById(R.id.entcFourthSpinner5);
        meSpinnerFirst6 = findViewById(R.id.entcFourthSpinner6);
        meSpinnerFirst7 = findViewById(R.id.entcFourthSpinner7);
        meSpinnerFirst8 = findViewById(R.id.entcFourthSpinner8);
        meSpinnerFirst9 = findViewById(R.id.entcFourthSpinner9);
        meSpinnerFirst10 = findViewById(R.id.entcFourthSpinner10);

        meFirstGr1= findViewById(R.id.entcGradeFourth1);
        meFirstGr2= findViewById(R.id.entcGradeFourth2);
        meFirstGr3= findViewById(R.id.entcGradeFourth3);
        meFirstGr4= findViewById(R.id.entcGradeFourth4);
        meFirstGr5= findViewById(R.id.entcGradeFourth5);
        meFirstGr6= findViewById(R.id.entcGradeFourth6);
        meFirstGr7= findViewById(R.id.entcGradeFourth7);
        meFirstGr8 = findViewById(R.id.entcGradeFourth8);
        meFirstGr9 = findViewById(R.id.entcGradeFourth9);
        meFirstGr10 = findViewById(R.id.entcGradeFourth10);
    ...
    public void displayResultEntcFourth(View view){
        double gp = record1*3+record2+record3*4+record4+record5*3+record6+record7*3+record8+record9*3+record10*3;
        double gpa = gp / 23;
