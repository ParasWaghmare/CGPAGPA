...
public class MechThirdSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mech_third_sem);

        display_data = findViewById(R.id.meThirdSgpa);
        csSecondPer = findViewById(R.id.meThirdPercentage);

        meSpinnerFirst1 = findViewById(R.id.meThirdSpinner1);
        meSpinnerFirst2 = findViewById(R.id.meThirdSpinner2);
        meSpinnerFirst3 = findViewById(R.id.meThirdSpinner3);
        meSpinnerFirst4 = findViewById(R.id.meThirdSpinner4);
        meSpinnerFirst5 = findViewById(R.id.meThirdSpinner5);
        meSpinnerFirst6 = findViewById(R.id.meThirdSpinner6);
        meSpinnerFirst7 = findViewById(R.id.meThirdSpinner7);
        meSpinnerFirst8 = findViewById(R.id.meThirdSpinner8);
        meSpinnerFirst9 = findViewById(R.id.meThirdSpinner9);
        meSpinnerFirst10 = findViewById(R.id.meThirdSpinner10);

        meFirstGr1 = findViewById(R.id.meGradeThird1);
        meFirstGr2 = findViewById(R.id.meGradeThird2);
        meFirstGr3 = findViewById(R.id.meGradeThird3);
        meFirstGr4 = findViewById(R.id.meGradeThird4);
        meFirstGr5 = findViewById(R.id.meGradeThird5);
        meFirstGr6 = findViewById(R.id.meGradeThird6);
        meFirstGr7 = findViewById(R.id.meGradeThird7);
        meFirstGr8 = findViewById(R.id.meGradeThird8);
        meFirstGr9 = findViewById(R.id.meGradeThird9);
        meFirstGr10 = findViewById(R.id.meGradeThird10);
    ...
    public void displayResultMeThird(View view){
