...
public class MechSecondSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mech_second_sem);

        display_data = findViewById(R.id.meSecondSgpa);
        csSecondPer  = findViewById(R.id.meSecondPercentage);

        meSpinnerFirst1 = findViewById(R.id.meSecondSpinner1);
        meSpinnerFirst2 = findViewById(R.id.meSecondSpinner2);
        meSpinnerFirst3 = findViewById(R.id.meSecondSpinner3);
        meSpinnerFirst4 = findViewById(R.id.meSecondSpinner4);
        meSpinnerFirst5 = findViewById(R.id.meSecondSpinner5);
        meSpinnerFirst6 = findViewById(R.id.meSecondSpinner6);
        meSpinnerFirst7 = findViewById(R.id.meSecondSpinner7);
        meSpinnerFirst8 = findViewById(R.id.meSecondSpinner8);
        meSpinnerFirst9 = findViewById(R.id.meSecondSpinner9);
        meSpinnerFirst10 = findViewById(R.id.meSecondSpinner10);

        meFirstGr1= findViewById(R.id.meGradeSecond1);
        meFirstGr2= findViewById(R.id.meGradeSecond2);
        meFirstGr3= findViewById(R.id.meGradeSecond3);
        meFirstGr4= findViewById(R.id.meGradeSecond4);
        meFirstGr5= findViewById(R.id.meGradeSecond5);
        meFirstGr6= findViewById(R.id.meGradeSecond6);
        meFirstGr7= findViewById(R.id.meGradeSecond7);
        meFirstGr8 = findViewById(R.id.meGradeSecond8);
        meFirstGr9 = findViewById(R.id.meGradeSecond9);
        meFirstGr10 = findViewById(R.id.meGradeSecond10);
    ...
    public void displayResultMeSecond(View view){
