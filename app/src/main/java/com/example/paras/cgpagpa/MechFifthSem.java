...
public class MechFifthSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mech_fifth_sem);

        display_data = findViewById(R.id.meFifthSgpa);
        csSecondPer = findViewById(R.id.meFifthPercentage);

        meSpinnerFirst1 = findViewById(R.id.meFifthSpinner1);
        meSpinnerFirst2 = findViewById(R.id.meFifthSpinner2);
        meSpinnerFirst3 = findViewById(R.id.meFifthSpinner3);
        meSpinnerFirst4 = findViewById(R.id.meFifthSpinner4);
        meSpinnerFirst5 = findViewById(R.id.meFifthSpinner5);
        meSpinnerFirst6 = findViewById(R.id.meFifthSpinner6);
        meSpinnerFirst7 = findViewById(R.id.meFifthSpinner7);
        meSpinnerFirst8 = findViewById(R.id.meFifthSpinner8);
        meSpinnerFirst9 = findViewById(R.id.meFifthSpinner9);
        meSpinnerFirst10 = findViewById(R.id.meFifthSpinner10);
        meSpinnerFirst11 = findViewById(R.id.meFifthSpinner11);

        meFirstGr1 = findViewById(R.id.meGradeFifth1);
        meFirstGr2 = findViewById(R.id.meGradeFifth2);
        meFirstGr3 = findViewById(R.id.meGradeFifth3);
        meFirstGr4 = findViewById(R.id.meGradeFifth4);
        meFirstGr5 = findViewById(R.id.meGradeFifth5);
        meFirstGr6 = findViewById(R.id.meGradeFifth6);
        meFirstGr7 = findViewById(R.id.meGradeFifth7);
        meFirstGr8 = findViewById(R.id.meGradeFifth8);
        meFirstGr9 = findViewById(R.id.meGradeFifth9);
        meFirstGr10 = findViewById(R.id.meGradeFifth10);
        meFirstGr11= findViewById(R.id.meGradeFifth11);
    ...
    public void displayResultMeFifth(View view){
