...
public class InstSecondSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inst_second_sem);


        display_data = findViewById(R.id.instSecondSgpa);
        csSecondPer  = findViewById(R.id.instSecondPercentage);

        meSpinnerFirst1 = findViewById(R.id.instSecondSpinner1);
        meSpinnerFirst2 = findViewById(R.id.instSecondSpinner2);
        meSpinnerFirst3 = findViewById(R.id.instSecondSpinner3);
        meSpinnerFirst4 = findViewById(R.id.instSecondSpinner4);
        meSpinnerFirst5 = findViewById(R.id.instSecondSpinner5);
        meSpinnerFirst6 = findViewById(R.id.instSecondSpinner6);
        meSpinnerFirst7 = findViewById(R.id.instSecondSpinner7);
        meSpinnerFirst8 = findViewById(R.id.instSecondSpinner8);
        meSpinnerFirst9 = findViewById(R.id.instSecondSpinner9);
        meSpinnerFirst10 = findViewById(R.id.instSecondSpinner10);

        meFirstGr1= findViewById(R.id.instGradeSecond1);
        meFirstGr2= findViewById(R.id.instGradeSecond2);
        meFirstGr3= findViewById(R.id.instGradeSecond3);
        meFirstGr4= findViewById(R.id.instGradeSecond4);
        meFirstGr5= findViewById(R.id.instGradeSecond5);
        meFirstGr6= findViewById(R.id.instGradeSecond6);
        meFirstGr7= findViewById(R.id.instGradeSecond7);
        meFirstGr8 = findViewById(R.id.instGradeSecond8);
        meFirstGr9 = findViewById(R.id.instGradeSecond9);
        meFirstGr10 = findViewById(R.id.instGradeSecond10);
    ...
    public void displayResultInstSecond(View view){
