...
public class InstSixthSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inst_sixth_sem);


        display_data = findViewById(R.id.instSixthSgpa);
        csSecondPer  = findViewById(R.id.instSixthPercentage);

        meSpinnerFirst1 = findViewById(R.id.instSixthSpinner1);
        meSpinnerFirst2 = findViewById(R.id.instSixthSpinner2);
        meSpinnerFirst3 = findViewById(R.id.instSixthSpinner3);
        meSpinnerFirst4 = findViewById(R.id.instSixthSpinner4);
        meSpinnerFirst5 = findViewById(R.id.instSixthSpinner5);
        meSpinnerFirst6 = findViewById(R.id.instSixthSpinner6);
        meSpinnerFirst7 = findViewById(R.id.instSixthSpinner7);
        meSpinnerFirst8 = findViewById(R.id.instSixthSpinner8);
        meSpinnerFirst9 = findViewById(R.id.instSixthSpinner9);
        meSpinnerFirst10 = findViewById(R.id.instSixthSpinner10);
        meSpinnerFirst11  = findViewById(R.id.instSixthSpinner11);

        meFirstGr1= findViewById(R.id.instGradeSixth1);
        meFirstGr2= findViewById(R.id.instGradeSixth2);
        meFirstGr3= findViewById(R.id.instGradeSixth3);
        meFirstGr4= findViewById(R.id.instGradeSixth4);
        meFirstGr5= findViewById(R.id.instGradeSixth5);
        meFirstGr6= findViewById(R.id.instGradeSixth6);
        meFirstGr7= findViewById(R.id.instGradeSixth7);
        meFirstGr8 = findViewById(R.id.instGradeSixth8);
        meFirstGr9 = findViewById(R.id.instGradeSixth9);
        meFirstGr10 = findViewById(R.id.instGradeSixth10);
        meFirstGr11 = findViewById(R.id.instGradeSixth11);
    ...
    public void displayResultInstSixth(View view){
